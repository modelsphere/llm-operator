...
IMG ?= harbor.4pd.io/hardcore-tech/llm-operator:0.2.1
export IMG
...
KIND_CLUSTER ?= llmscaleoperator-test-e2e
...
docker-buildx: ## Build and push docker image for the manager for cross-platform support
	...
	- $(CONTAINER_TOOL) buildx create --name llmscaleoperator-builder
	$(CONTAINER_TOOL) buildx use llmscaleoperator-builder
...
HELM_NAMESPACE ?= llmscaleoperator-system
## Name of the Helm release
HELM_RELEASE ?= llmscaleoperator
