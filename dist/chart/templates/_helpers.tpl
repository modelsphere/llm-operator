...
*/}}
{{- define "llmscaleoperator.fullname" -}}
...
*/}}
{{- define "llmscaleoperator.namespaceName" -}}
{{- .Release.Namespace }}
{{- end }}
...
*/}}
{{- define "llmscaleoperator.resourceName" -}}
{{- $fullname := include "llmscaleoperator.fullname" .context }}
{{- $suffix := .suffix }}
...
*/}}
{{- define "llmscaleoperator.serviceAccountName" -}}
{{- if and (not (.Values.serviceAccount.enabled | default true)) .Values.serviceAccount.name }}
{{- .Values.serviceAccount.name }}
{{- else }}
{{- include "llmscaleoperator.resourceName" (dict "suffix" "controller-manager" "context" .) }}
{{- end }}
{{- end }}
